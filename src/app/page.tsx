...
export default function Home() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-br from-emerald-50 via-green-50 to-teal-50 flex items-center justify-center p-4 relative overflow-hidden" style={{background:"#B8EBD7"}}>
          ...
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl shadow-2xl p-8 md:p-10 border border-white/20">
            ...
            {view === "phone" ? (
              ...
              <>
                  ...
                  {view === "login" && (
                    <div className="flex items-center justify-between text-sm">
                      ...
                      <button
                        ...
                        className="hover:text-red-500 font-medium text-red-500"
                      >
                        Forgot password?
                      </button>
                    </div>
                ...
                {/* Social login */}
                <div className="grid grid-cols-3 gap-4 [&>*:only-child]:col-span-full ">
                  <button
